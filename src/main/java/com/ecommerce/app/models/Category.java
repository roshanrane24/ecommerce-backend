...
@Document(collection = "categories")  //@Document annotation use to set the collection name that will be used by the model. If the collection doesn’t exist, MongoDB will create it.
